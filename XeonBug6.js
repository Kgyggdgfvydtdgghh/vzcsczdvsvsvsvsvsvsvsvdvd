...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`💬`).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEitmfRO1947wm1d7JWMhqjY85cVpDsajK5v_Na7Gvh16yZVaSfPEAVfaBthcw57oblAFwhLb0mA03G-DKqWNVxv76gd_eyJOxx9vQhfTBBFK1pY84TSkamWFpH7hneXX6dItyeR-VWy8WwEUbHjfZz6G8a4IMxLwNIXyhhCKa7rKEUdR07VrEhHFTU7KKpu/s1280/IMG-20240701-WA0023.jpg',
...
`.trim()
            ...
            case 'donate':
            case 'donasi':
                let textnate = `🤖 ${pushname}\n\n🤖`
                XeonBotInc.sendMessage(m.chat, {
                    text: 'https://google-ai-x.blogspot.com/\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
break
            case 'afk':
                ...
                break
case 'play':  case 'song': {
if (!text) return replygcxeon(`Example : ${prefix + command} Music name 🎵🎶`)
...
*Visit on 🔗*
> _https://google-ai-x.blogspot.com/_
